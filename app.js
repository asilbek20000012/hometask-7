// 1. 10 dan 100 gacha bo'lgan sonlarning 2ga bo'linadiganlari va 3ga bo'linadiganlarini chiqarish
...
// 2. 20 dan 50 gacha bo'lgan sonlarning faqat 5ga bo'linadiganlarini chiqarish
for (let i = 20; i <= 50; i++) {
    if (i % 5 === 0) {
...
// 3. 1 dan 100 gacha bo'lgan sonlarning kvadratlarining yig'indisini hisoblash
let sum = 0;
for (let i = 1; i <= 100; i++) {
    sum += i * i;
}
...
// 4. 1 dan 50 gacha bo'lgan sonlarning kubiklarini chiqarish
for (let i = 1; i <= 50; i++) {
    console.log(i + " ning kubi: " + i * i * i);
}

// 5. 10 dan 100 gacha bo'lgan sonlarning juft yoki toqligini tekshirish
for (let i = 10; i <= 100; i++) {
    if (i % 2 === 0) {
        console.log(i + " juft");
    } else {
...
// 6. 5 dan 100 gacha bo'lgan barcha sonlarning yig'indisini hisoblash, lekin 7ga bo'linadiganlarni hisoblashdan chetlatish
sum = 0;
for (let i = 5; i <= 100; i++) {
    if (i % 7 !== 0) {
        sum += i;
...
// 7. 50 dan 150 gacha bo'lgan sonlarning faqat juftlarini chiqarish
...
// 8. 1 dan 100 gacha bo'lgan sonlarning ko'paytmalarini topish va 10000dan kichik bo'lsa, natijani ekranga chiqarish
let product = 1;
for (let i = 1; i <= 100; i++) {
    product *= i;
...
// 9. 1 dan 100 gacha bo'lgan sonlarning 6ga bo'linadiganlarini ekranga chiqarish
for (let i = 1; i <= 100; i++) {
    if (i % 6 === 0) {
...
// 10. 1 dan 50 gacha bo'lgan sonlar uchun ular juftmi yoki toqmi ekanligini aniqlab chiqarish
for (let i = 1; i <= 50; i++) {
    if (i % 2 === 0) {
        console.log(i + " juft");
    } else {
...
// 11. 1 dan 1000 gacha bo'lgan sonlar orasida faqat 4, 5 va 7ga bo'linadigan sonlarni topish va ularning yig'indisini hisoblash
sum = 0;
...
// 12. 1 dan 10000 gacha bo'lgan sonlar orasida faqat 6ga bo'linadigan va 8ga bo'linmaydigan sonlarni chiqarib, ularning kvadratlarini hisoblash
...
// 13. 100 dan 2000 gacha bo'lgan sonlar orasida faqat 9ga bo'linadigan va 5ga bo'linadigan sonlarni chiqarib, ularning yig'indisini hisoblash
sum = 0;
...
// 14. 1 dan 1000 gacha bo'lgan sonlar orasida faqat 2ga, 3ga va 5ga bo'linadigan sonlarni topish va ularning kubiklarini hisoblash
for (let i = 1; i <= 1000; i++) {
...
// 15. 1 dan 10000 gacha bo'lgan sonlar orasida 3ga bo'linadigan, 4ga bo'linadigan va 5ga bo'linmaydigan sonlarning yig'indisini hisoblash
sum = 0;
for (let i = 1; i <= 10000; i++) {
...
// 16. 100 dan 10000 gacha bo'lgan sonlar orasida faqat 2ga bo'linadigan va 6ga bo'linmaydigan sonlarni chiqarib, ularning kubiklarini hisoblash
...
// 18. 1 dan 10000 gacha bo'lgan sonlar orasida faqat 3ga bo'linadigan va 6ga bo'linadigan sonlarning yig'indisini hisoblash, lekin 2000dan katta bo'lsa, "Katta" deb chiqaring
sum = 0;
for (let i = 1; i <= 10000; i++) {
    if (i % 3 === 0 && i % 6 === 0) {
        sum += i;
